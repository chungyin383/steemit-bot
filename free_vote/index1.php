			...
			try {
				steem.api.getDynamicGlobalProperties(function(err, result) {
					if (err === null) {
						...
						$('#selfcheck_status').html('今次仆街了，我真係恭喜你呀。<br>' + err);
					}
				});
			}
			catch(err) {
				$('#selfcheck_status').html('今次仆街了，我真係恭喜你呀。<br><br>' + err.message);
			}
		}
...
<body>
	...
	<div class="section">
		...
		<div class="instruction">以下會嘗試自我檢查睇吓一切是否安好，如果仲有問題的話...我除咗講恭喜之外，都唔知應該講乜嘢好啦。</div>
