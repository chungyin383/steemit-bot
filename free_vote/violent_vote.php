						...
						setTimeout(function(){
							...
							steem.api.getContent(author, permlink, function(err, result) {
								...
								for (var j in votedList){
									if (votedList[j].voter == username && votedList[j].percent > 100){
										found = true;
										break;
									}
								}
...
<body>
	...
	<div class="section">
		...
		<div class="instruction">以下會嘗試自我檢查睇吓一切是否安好，如果有問題的話可以嘗試去呢條後備link：<a href='http://steem.net23.net/index1.php'>steem.net23.net/index1.php</a>。</div>
